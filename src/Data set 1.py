...
x = pd.read_csv('data1_xvalue.csv', sep=',', header=None)
y = pd.read_csv('data1_yvalue.csv', sep=',', header=None)
...
n0s = np.linspace(-0.2, 4, 200) 
n1s = np.linspace(53, -53, 200)
N1, N2 = np.meshgrid(n0s, n1s) # create meshgrid 
...
ax0.set_xlabel(r'$AdjSOT$', fontsize=label_font_size, labelpad=8)
