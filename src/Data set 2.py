...
x = pd.read_csv('data2_xvalue.csv', sep=',', header=None)
y = pd.read_csv('data2_yvalue.csv', sep=',', header=None)
...
n0s = np.linspace(-0.2, 5, 200) 
n1s = np.linspace(100, -100, 200)
